...
// void drawaustralia();
// void drawusahotel();
// void drawrussiahotel();
// void drawfrancehotel();
// void drawaushotel();
...
// void drawhome()
// {
//     // adding the home pages
//     iSetColor(0, 0, 0);
//     iFilledRectangle(0, 0, 1136, 592);
//     iShowBMP2(0, 0, "photo\\home.bmp", 0);

//     // adding the home pages button
//     // iShowBMP2(810, 454, "photo\\picture2.bmp", 0);
//     // iShowBMP2(810, 354, "photo\\picture3.bmp", 0);
//     // iShowBMP2(810, 254, "photo\\picture4.bmp", 0);

//     // adding the home page button text
//     // iSetColor(0, 0, 0);
//     // iText(850, 479, "Tourists spots", GLUT_BITMAP_TIMES_ROMAN_24);
//     // iText(850, 379, "Settings", GLUT_BITMAP_TIMES_ROMAN_24);
//     // iText(850, 279, "About us", GLUT_BITMAP_TIMES_ROMAN_24);
//     // iText(797, 156, "Hello,Welcome to the", GLUT_BITMAP_TIMES_ROMAN_24);
//     // iText(797 - 30, 156 - 50, "Virtual Tourist Guide Software", GLUT_BITMAP_TIMES_ROMAN_24);
// }
...
void drawureview(){
    ...
    iSetColor(255, 0, 0);
    // iText(109,445,reviewstr[0],GLUT_BITMAP_TIMES_ROMAN_24);
    // iText(109,405,reviewstr[1],GLUT_BITMAP_TIMES_ROMAN_24);
    // iText(109,365,reviewstr[2],GLUT_BITMAP_TIMES_ROMAN_24);
    // iText(109,325,reviewstr[3],GLUT_BITMAP_TIMES_ROMAN_24);
    // iText(109,285,reviewstr[4],GLUT_BITMAP_TIMES_ROMAN_24);
    // int control=0;
    ...
    // int xco=109,yco=445;
    // while(!feof(files)){
    //     fgets(reviewstr1,50,files);
    //     iText(xco,yco,reviewstr1,GLUT_BITMAP_TIMES_ROMAN_24);
    //     yco-=30;
    //     // control++;
    // }
}
